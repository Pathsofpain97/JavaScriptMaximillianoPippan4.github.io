...
function agregarAlCarrito(e) {
    ...
    Toastify({
        ...
        duration: 1000,
        gravity: "bottom", // `arriba` o `abajo`
        position: "center", // `izquierda`, `centro` o `derecha`
        stopOnFocus: true, // Evita que se descarte el toast al pasar el mouse
        style: {
...
function eliminarDelCarrito(e) {
    ...
    Toastify({
        ...
        duration: 1000,
        gravity: "bottom", // `arriba` o `abajo`
        position: "center", // `izquierda`, `centro` or `derecha`
        stopOnFocus: true, // Evita que se descarte el toast al pasar el mouse
        style: {
            background: "linear-gradient(to right, #F9C521, #f99b21)",
            borderRadius: "2rem",
